package com.example.du.endlessrecyclerview.custom.classes;
...
// code from here: https://gist.github.com/nesquena/8a976dd3d6f866518db2cfe7f9cb0db7
// explaination can be get at : https://guides.codepath.com/android/Endless-Scrolling-with-AdapterViews-and-RecyclerView#troubleshooting
/**
 * Created by linus.du on 9/1/16.
 */
public abstract class EndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
        ...
        // if we do need to reload some more data, we execute onLoadMore to fetch the data. threshold should reflect how may total columns there are too
